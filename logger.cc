...
#ifdef _MSC_VER
#define TRED    FOREGROUND_RED | FOREGROUND_INTENSITY                       // 红
#define TGREEN  FOREGROUND_GREEN | FOREGROUND_INTENSITY                     // 绿
#define TYELLOW FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_INTENSITY    // 黄
#define TNORMAL FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_BLUE         // 普通
#define TWHITE  TNORMAL | FOREGROUND_INTENSITY                              // 白
#define TBLUE   FOREGROUND_BLUE | FOREGROUND_GREEN | FOREGROUND_INTENSITY   // 蓝
#else
#define TRED    1 // 红
#define TGREEN  2 // 绿
#define TYELLOW 3 // 黄
